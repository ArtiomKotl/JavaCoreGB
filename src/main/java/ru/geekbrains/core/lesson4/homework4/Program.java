...
public class Program {
    public static void main(String[] args) {
        ...
        System.out.println("4. Перевод со счЁта на счёт:");
        System.out.println(debitAccount);
        System.out.println(creditAccount);
        while (true) {
            try {
                double money = prompt("Введите сумму перевода с дебетового счёта на кредитный счёт:\n");
                ...
                System.out.printf("Кредитный счёт пополнен на %.2f!\n " +
                                "Баланс кредитного счёта составляет - %.2f\n " +
                                "Дебетовый счёт опустел на %.2f!\n " +
                                "Баланс дебетового счёта составляет - %.2f\n",
